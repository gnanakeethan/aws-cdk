...
import type { AddServiceProps, AstBuilderProps, SubmoduleInfo } from '@aws-cdk/spec2cdk/lib/cdk/ast';
import { AstBuilder } from '@aws-cdk/spec2cdk/lib/cdk/ast';
import type { ModuleImportLocations } from '@aws-cdk/spec2cdk/lib/cdk/cdk';
...
export class MixinAstBuilder extends AstBuilder {
  ...
  protected addImports(targetModule: Module, importLocations?: ModuleImportLocations) {
    CDK_CORE.import(targetModule, 'cdk', { fromLocation: importLocations?.core });
  ...
  protected addResourceToSubmodule(submodule: SubmoduleInfo, resource: Resource, _props?: AddServiceProps) {
    ...
    this.addSelectiveImports(l1PropsMixin.imports);
  }
}
